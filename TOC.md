...
1. [**The Art and Science of Sound**](lessons/part_1/1.sound.html)
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;1.2.3 [Pauline Oliveros](lessons/part_1/1.2.3.oliveros.html)<br>
...
3. [**Synthesis**](lessons/part_3/3.Synthesis.html)
    ...
    3.2 [Synthesizer History](lessons/part_3/3.2.synth-history.html)

    3.3 [Listening for Synths in Music](lessons/part_3/3.3.synth-listening.html)

    3.4 [Create and edit a synth patch](lessons/part_3/3.4.synth-edit.html)

4. [**Sequencing**](lessons/part_4/4.Sequencing.html)

    4.1 [Musical Time](lessons/part_4/4.1.musical-time.html)

    4.2 [Beat Patterns](lessons/part_4/4.2.beat-patterns.html)

    4.3 [Note Sequences](lessons/part_4/4.3.note-sequences.html)

    4.4 [Listening: Terry Riley's "In C"](lessons/part_4/4.4.listening-InC.html)
